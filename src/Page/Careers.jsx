...
const fallbackJobs = [
  {
    ...
    experience: '1+ years',
    description: 'Build clean websites, dashboards, and business portals with the CODELUX team.',
    applyEmail: 'codeluxtechnology@gmail.com',
  },
]
    ...
    <section id="jobs" className="relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-2">
          {visibleJobs.map((job) => (
            <article className="soft-lift reveal-on-scroll rounded-lg border border-slate-200 bg-white/95 p-6 shadow-sm hover:border-blue-200 hover:shadow-xl hover:shadow-blue-950/10" key={job.id}>
              ...
              <a className="mt-6 inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-slate-950 px-5 text-sm font-black text-white no-underline transition hover:-translate-y-0.5 hover:bg-blue-700" href={`mailto:${job.applyEmail || 'codeluxtechnology@gmail.com'}?subject=${encodeURIComponent(job.title)}`}>
                Apply Now
